<div class="content-block-title">Terms of Use</div>
    <div class="content-block inset">
      <div class="content-block-inner">
        
        Copyright (C) 2008-2013 Andrei Busuioc (Devman)<br><br>
 Copyright (C) 2015-2016 Tobias Strunz (Fhizban)<br><br>
  ...
  All user data is private.<br><br>
  
  <a class="external" rel="license" href="http://creativecommons.org/licenses/by/4.0/">
  <img alt="Creative Commons Licencse" style="border-width:0" src="https://i.creativecommons.org/l/by/4.0/88x31.png">
  </a>
