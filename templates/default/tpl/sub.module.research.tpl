<div class="swiper-slide">
    ...
    <div class="card-content-inner">
			...
			<div class="col-25">
				<img src="{{tvar_global_directory}}templates/{{tvar_global_template}}/images/technologies/{{tvar_nodeFaction}}/{{tvar_image}}" style="border-style: solid; border-size: 1;" width="80">
			</div>
